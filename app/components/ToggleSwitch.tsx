...
const ToggleSwitch = ({ setIsDarkMode, onSubmit }: any) => {
  ...
  return (
    <>
      <label className="themeSwitcherTwo dark:bg-gray-700 shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-white p-1">
        <input
          type="checkbox"
          className="sr-only"
          checked={isChecked}
