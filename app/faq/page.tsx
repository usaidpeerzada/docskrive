...
export default function page() {
  return (
    <div className="min-h-screen flex justify-center items-center bg-teal-600">
      <div
        className=" px-5 mt-10 mb-10 bg-gray-200 border rounded"
        style={{ width: "600px" }}
      >
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="text-neutral-600 mt-3 visible">
                ...
                creation, management, and sharing of coding documentation.
                Utilizing OpenAI and Gemini API, it effortlessly generates
                precise documentation from URLs, files, or text. Enhance clarity
